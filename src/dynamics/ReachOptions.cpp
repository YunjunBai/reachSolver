...
template <typename Number>
const Number ReachOptions<Number>::uTrans_nonlin() const{
    return uTrans_nonlin_;
}

template <typename Number>
void ReachOptions<Number>::set_uTrans_nonlin(Number uTrans_nonlin){
...
template <typename Number>
const int ReachOptions<Number>::verbose() const{
    return verbose_;
}

template <typename Number>
void ReachOptions<Number>::set_verbose(int verbose){
    verbose_ = verbose;
}

template <typename Number>
const int ReachOptions<Number>::max_error() const{
    return max_error_;
}

template <typename Number>
void ReachOptions<Number>::set_max_error(int max_error){
...
template <typename Number>
const int ReachOptions<Number>::reductionInterval() const{
    return reductionInterval_;
}

template <typename Number>
void ReachOptions<Number>::set_reductionInterval(int reductionInterval){
